...
export default function Student({ params: { id } }: ProductEdit) {
  ...
  const handleUpdate = async () => {
    ...
    api
      .put(`/student/${id}`, { ...student, quiz: JSON.stringify(quiz) })
      .then((e) => {
        toast({
                    ...
                    <Flex justifyContent={"space-between"}>
                      ...
                      <FormControl mb={4}>
                        ...
                        <Checkbox
                          ...
                          name="status"
                          placeholder="Status"
                          isChecked={student.status}
                          borderColor={"black"}
                          onChange={(e) => {
                            setStudent({ ...student, status: !student.status });
                          }}
                        ></Checkbox>
                      </FormControl>
                    </Flex>
                      ...
                      <Box paddingLeft={1}>
                        <Flex justifyContent={"space-between"}>
                          <FormControl mb={4} mr="3%" maxW={"30%"}>
                            ...
                            <Input
                              ...
                              value={student?.uf}
                              onChange={(e) => {
                                setStudent({ ...student, uf: e.target.value });
                              }}
                            />
                          </FormControl>
                          <FormControl mb={4}>
                            ...
                            <Input
                              ...
                              value={student?.cep}
                              onChange={(e) => {
                                setStudent({ ...student, cep: e.target.value });
                              }}
                            />
                          </FormControl>
                        </Flex>
                        ...
                        <FormControl mb={4}>
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              setStudent({ ...student, street: e.target.value });
                            }}
                          />
                        </FormControl>
                        <Flex justifyContent={"space-between"}>
                  ...
                  <Box flex="1" mr={{ md: 4 }}>
                    ...
                    <FormControl display="flex" alignItems="center" mb={4}>
                      ...
                      <Switch
                        id="planosaude"
                        mr={4}
                        isChecked={quiz?.health_insurance}
                        onChange={(e) => {
                          setQuiz({ ...quiz, health_insurance: !quiz.health_insurance });
                        }}
                      />
                      {quiz.health_insurance && (
                        <Input
                          id="planosaude_text"
                          name="planosaude_text"
                          placeholder=""
                          value={quiz?.health_insurance_text}
                          onChange={(e) => {
                            setQuiz({ ...quiz, health_insurance_text: e.target.value });
                          }}
                        />
                      )}
                    </FormControl>
                    <FormControl display="flex" alignItems="center" mb={4}>
                      ...
                      <Switch
                        id="praticaesporte"
                        mr={4}
                        isChecked={quiz?.other_sport}
                        onChange={(e) => {
                          setQuiz({ ...quiz, other_sport: !quiz.other_sport });
                        }}
                      />
                      {quiz.other_sport && (
                        <Input
                          id="praticaesporte_text"
                          name="praticaesporte_text"
                          placeholder=""
                          value={quiz?.other_sport_text}
                          onChange={(e) => {
                            setQuiz({ ...quiz, other_sport_text: e.target.value });
                          }}
                        />
                      )}
                    </FormControl>
                    ...
                    >
                      {quiz?.why_do &&
                        question1Options.map((item) => (
                          <Checkbox
                            key={item.id}
                            borderColor={"black"}
                            isChecked={quiz?.why_do.includes(item?.id)}
                            onChange={(e) => {
                              setQuiz({
                                ...quiz,
                                why_do: quiz?.why_do.includes(item?.id)
                      ...
                      {quiz?.why_do.includes(9) && (
                        <Input
                          ...
                          name="porque_text"
                          placeholder=""
                          value={quiz?.why_do_text}
                          onChange={(e) => {
                            setQuiz({ ...quiz, why_do_text: e.target.value });
                          }}
                        />
                      )}
                    </FormControl>
                    ...
                    >
                      {question2Options.map((item) => (
                        <Checkbox
                          key={item.id}
                          borderColor={"black"}
                          isChecked={quiz?.how_know.includes(item?.id)}
                          onChange={(e) => {
                            setQuiz({
                              ...quiz,
                              how_know: quiz?.how_know.includes(item?.id)
                      ...
                      {quiz?.how_know.includes(9) && (
                        <Input
                          id="como"
                          name="como_text"
                          placeholder=""
                          value={quiz?.how_know_text}
                          onChange={(e) => {
                            setQuiz({ ...quiz, how_know_text: e.target.value });
                          }}
                        />
                      )}
                    </FormControl>
