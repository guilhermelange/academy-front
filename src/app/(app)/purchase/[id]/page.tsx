  ...
  useEffect(() => {
    if (id > 0) {
      api.get(`/purchase/${id}`).then((item) => {
        ...
        setProducts(
          purchaseData?.purchase_item.map((item: any) => {
            return {
              id: item.id,
              amount: item.amount,
  ...
  useEffect(() => {
    if (purchase.type == "registration") {
      ...
      if (products && products.length > 0) {
        ...
        setPurchase({ ...purchase, value: Number(newValue.toFixed(2)) });
      } else {
                ...
                <FormControl mb={4}>
                  ...
                  {!(id > 0) && (
                    <Select
                      ...
                      onChange={(e: any) => {
                        setPurchase({ ...purchase, student_id: e.value });
                      }}
                    />
                  )}
                  {id > 0 && <Input colorScheme={"blackAlpha"} isReadOnly value={purchase.student.name} />}
                </FormControl>
                {id > 0 && purchase.registration_id > 0 && (
                  <FormControl mb={4}>
                    ...
                    <Link href={`/registration/${purchase.registration_id}`}>
                      <Input
                        ...
                        value={purchase.registration_id}
                        isReadOnly
                      />
                    </Link>
                  </FormControl>
                ...
                <FormControl mb={4}>
                  ...
                  {id > 0 && (
                    <Input
                      ...
                      isReadOnly
                      value={purchase.payment_type == "cash" ? "A Vista" : "Parcelado"}
                    />
                  )}
                </FormControl>
                ...
                <FormControl mb={4}>
                  ...
                  {!(id > 0) && (
                    <Select2
                      ...
                      value={purchase.type}
                      onChange={(e) => {
                        setPurchase({ ...purchase, type: e.target.value });
                      }}
                      isReadOnly={!(id > 0)}
                    >
                ...
                {id > 0 && (
                  <FormControl mb={4}>
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        setPurchase({ ...purchase, creation_date: e.target.value });
                      }}
                      isReadOnly
                    />
                  </FormControl>
                              ...
                              {!(id > 0) && (
                                <Td textAlign={"right"}>
                                  ...
                                  <IconButton
                                    ...
                                    ml="2"
                                    onClick={() => {
                                      setProducts(products.filter((aux) => aux.id !== product.id));
                                    }}
                                  />
                                </Td>
                              )}
                              ...
                              <Tr key={installment.id}>
                                ...
                                <Td>
                                  <Select2
                                    ...
                                    onChange={(e) => {
                                      handleUpdateInstallmentStatus(installment.id, e.target.value);
                                    }}
                                  >
                                    <option value="pending">Pendente</option>
                                    <option value="paid">Pago</option>
